...
class SEOMainDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function (SEOMain $seo) {
                return view('pages/apps.SEOMain.columns._actions', compact('seo'));
            })
            ->setRowId('id');
    }
     ...
     */
    public function query(SEOMain $model): QueryBuilder
    {
